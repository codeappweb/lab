...
Framework: Jekyll, GitHub Pages project site. Base URL: https://codeappweb.github.io/lab/ — `_config.yml` đặt `baseurl: "/lab"`, mọi internal link trong nội dung dùng prefix `/lab/`. Bài viết là Markdown trong `_posts/`, permalink `/:title/`. Hub pages trong `hub/`.
...
- Project đã ở root repo `codeappweb/lab`, GitHub Pages publish từ root, live URL: https://codeappweb.github.io/lab/ — mọi internal link dùng prefix `/lab/`.
- Next: xác nhận live site, rồi batch-002 theo `data/progress.json > next_actions`.
